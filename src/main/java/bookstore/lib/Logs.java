...
public class Logs {
    ...
    public static void logPurchase(UUID listingUUID, UUID userUUID, UUID sellerUUID, double sellPrice, double buyPrice, String bookTitle) {
        ...
        System.out.println("NEW PURCHASE LOGGED: Listing UUID: " + listingUUID  + ", Buyer UUID: " + userUUID + ", Seller UUID: " + sellerUUID + ", Sell Price: " + sellPrice + ", Buy Price: " + buyPrice + ", Book Title: " + bookTitle);
    }
